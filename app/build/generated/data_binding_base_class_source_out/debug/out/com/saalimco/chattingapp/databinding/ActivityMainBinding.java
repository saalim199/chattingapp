...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RoundedImageView imageProfile, @NonNull AppCompatImageView imglogout,
      @NonNull ProgressBar progressBar, @NonNull TextView txtName) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imglogout;
      AppCompatImageView imglogout = ViewBindings.findChildViewById(rootView, id);
      if (imglogout == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, conversationRecyclerView,
          fabNewChat, imageProfile, imglogout, progressBar, txtName);
    }
